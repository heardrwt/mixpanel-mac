...
@synthesize superProperties=_superProperties;
@synthesize timer=_timer;
@synthesize eventsQueue=_eventsQueue;
@synthesize peopleQueue=_peopleQueue;
@synthesize eventsBatch=_eventsBatch;
@synthesize peopleBatch=_peopleBatch;
@synthesize eventsConnection=_eventsConnection;
@synthesize peopleConnection=_peopleConnection;
@synthesize eventsResponseData=_eventsResponseData;
@synthesize peopleResponseData=_peopleResponseData;
...
#else
        //TODO: Mac Network Indicator Support
        if (visible){
            DevLog(@"Network Activity Indicator is now visible");
        } else {
            DevLog(@"Network Activity Indicator is no longer visible");
        }
#endif
    }
}
...
- (void)applicationWillResignActive:(NSNotification *)notification
{
    ...
    @synchronized(self) {
        ...
        //On the mac, there is no concept of Entering Background, so we instead use Resign Active
#if MP_OS_MAC
...
@synthesize distinctId=_distinctId;
@synthesize unidentifiedQueue=_unidentifiedQueue;
...
+ (NSDictionary *)deviceInfoProperties
{
    ...
    NSProcessInfo *processInfo = [NSProcessInfo processInfo];
    NSMutableDictionary *properties = [NSMutableDictionary dictionary];
    [properties setValue:[Mixpanel deviceModel] forKey:@"$mac_device_model"];
